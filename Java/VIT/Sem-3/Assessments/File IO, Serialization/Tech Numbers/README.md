...
20 + 25 = 45, and 45² = 2025.

Write a program that reads n integers from the user and saves them in a file named numbers.txt. The program should then read the numbers from this file, identify all tech numbers, and write the results to results.txt.
